...
import com.hen.data.data.source.local.datastore.NightModeViewModel
import com.hen.data.domain.model.User
import com.hen.data.utils.reduceFileImage
import com.hen.data.utils.uriToFile
import com.hen.book.R
import com.hen.book.activity.blur.BlurActivity
import com.hen.book.databinding.ActivityProfileBinding
...
class ProfileActivity : AppCompatActivity() {
    ...
    private fun onClick() {
        ...
        binding.saveProfile.setOnClickListener {
            ...
            if (book != null) {
                profileViewModel.updateUser(book)
                Log.d("Profile", " updated book")
            }
            Log.d("Profile", "book not updated ")
